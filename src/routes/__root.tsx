...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Global Property Tycoon" },
      {
        name: "description",
        content:
          "Build your global real estate empire. Buy properties around the world, collect rent, upgrade your assets, and become the ultimate property tycoon.",
      },
